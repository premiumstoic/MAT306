  ...
  return (
    <main className="min-h-screen p-4 md:p-8 xl:p-12 max-w-[1600px] mx-auto flex flex-col items-center justify-center space-y-12 relative overflow-hidden">
      ...
      <header className="text-center space-y-6 z-10 pt-16">
        ...
        <h1 className="text-6xl md:text-8xl font-extrabold tracking-tight bg-gradient-to-br from-white via-white/80 to-white/30 bg-clip-text text-transparent drop-shadow-sm pb-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-5xl z-10 mt-12 pb-24">
        {/* Week 4 Card */}
        <Link href="/week4" className="group relative block p-8 rounded-3xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300 hover:border-primary/50 overflow-hidden transform hover:-translate-y-1 shadow-2xl hover:shadow-primary/20">
          ...
          <div className="relative z-10 flex flex-col h-full space-y-4">
            ...
            <h2 className="text-3xl font-bold text-white group-hover:text-primary transition-colors">Week 4: Butane Dynamics</h2>
        ...
        {/* Homework 1 Card */}
        <Link href="/hw1" className="group relative block p-8 rounded-3xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300 hover:border-blue-500/50 overflow-hidden transform hover:-translate-y-1 shadow-2xl hover:shadow-blue-500/20">
          <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
          <div className="relative z-10 flex flex-col h-full space-y-4">
            <div className="w-14 h-14 rounded-2xl bg-blue-500/20 flex items-center justify-center text-blue-400 text-2xl font-bold mb-2 shadow-inner border border-blue-500/20">
              H1
            </div>
            <h2 className="text-3xl font-bold text-white group-hover:text-blue-400 transition-colors">Homework 1</h2>
            <p className="text-muted-foreground text-lg flex-grow leading-relaxed">
              Dive into the first homework assignment. Analyze simulation data and complete interactive modules designed for MAT 306.
            </p>
            <div className="flex items-center text-blue-400 font-semibold mt-6 group-hover:translate-x-3 transition-transform duration-300 text-lg">
      ...
      <footer className="absolute bottom-8 w-full text-center text-sm text-white/30 z-10 font-medium tracking-wide">
